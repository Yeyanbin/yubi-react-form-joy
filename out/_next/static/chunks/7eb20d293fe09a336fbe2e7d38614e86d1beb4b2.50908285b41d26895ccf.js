        ...
        return (
          u.every(function (t) {
            ...
            return (
              ...
              (u || t in i) &&
                (n = n.replace(c, o ? e.map(p.default).join('/') : (0, p.default)(e)) || '/')
            )
          }) || (n = ''),
          { params: u, result: n }
        )
        ...
        return (
          u(t, [
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 34:
                              return (w = e.sent), (e.next = 37), (0, s.getClientBuildManifest)()
                            case 37:
                            ...
                            case 45:
                              if (
                                ((f = this._resolveHref(f, w)).pathname !== y &&
                                  ((y = f.pathname), (n = (0, h.formatWithValidation)(f))),
                              ...
                              if (
                                ((N = (0, v.parseRelativeUrl)(T)),
                                (D = N.pathname),
                                (M = (0, g.getRouteRegex)(j)),
                                (U = (0, m.getRouteMatcher)(M)(D)),
                                (W = (q = j === D) ? R(j, D, b) : {}),
                                U && (!q || W.result))
                              ) {
                                e.next = 68
                              ...
                              if (
                                !(
                                  (F = Object.keys(M.groups).filter(function (t) {
                                    return !b[t]
                                  })).length > 0
                                )
                              ) {
                              ...
                              throw new Error(
                                (q
                                  ? 'The provided `href` ('
                                      ...
                                      .concat(F.join(', '), ') to be interpolated properly. ')
                                  : 'The provided `as` value ('
                                      .concat(D, ') is incompatible with the `href` value (')
                                      .concat(j, '). ')) +
                                  'Read more: https://err.sh/vercel/next.js/'.concat(
                                    q ? 'href-interpolation-failed' : 'incompatible-href-as',
                                  ),
                              )
                            case 66:
                              e.next = 69
                            ...
                            case 73:
                              if (
                                ...
                                (V = G.__N_SSG),
                                (z = G.__N_SSP),
                                !((V || z) && H && H.pageProps && H.pageProps.__N_REDIRECT))
                              ) {
                                e.next = 85
                                break
                              }
                              if (!(K = H.pageProps.__N_REDIRECT).startsWith('/')) {
                                e.next = 83
                                break
                              }
                              if (
                                ((Y = (0, v.parseRelativeUrl)(K)),
                                this._resolveHref(Y, w, !1),
                                !w.includes(Y.pathname))
                              ) {
                                e.next = 83
                                break
                              }
                              return (
                                ...
                                (J = $.url),
                                (Q = $.as),
                                e.abrupt('return', this.change(r, J, Q, i))
                              )
                            case 83:
                              return (
                            ...
                            case 85:
                              return (
                                ...
                                this.changeState(r, n, a, i),
                                (e.next = 90),
                                this.set(j, y, b, l, G).catch(function (t) {
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 12:
                              ...
                              return (
                                (e.next = 19),
                                this._getStaticData(
                                  this.pageLoader.getDataHref('/404', '/404', !0, this.locale),
                                )
                              )
                            case 19:
                              f = e.sent
                            ...
                            case 31:
                              ...
                              return (
                                (e.prev = 33),
                                (e.next = 36),
                                this.getInitialProps(c, { err: r, pathname: n, query: a })
                              )
                            case 36:
                            ...
                            case 39:
                              ;(e.prev = 39),
                                (e.t1 = e.catch(33)),
                                console.error('Error in error page `getInitialProps`: ', e.t1),
                                (y.props = {})
                            case 43:
                            ...
                            case 46:
                              return (
                                (e.prev = 46),
                                (e.t2 = e.catch(6)),
                                e.abrupt('return', this.handleRouteInfoError(e.t2, n, a, i, !0))
                              )
                            case 49:
                            case 'end':
                              return e.stop()
                          ...
                          switch ((t.prev = t.next)) {
                              ...
                              return (
                                (f || p) &&
                                  (d = this.pageLoader.getDataHref(
                                    (0, h.formatWithValidation)({ pathname: r, query: n }),
                                    k(a),
                                    f,
                                    this.locale,
                                  )),
                                ...
                                this._getData(function () {
                                  return f
                                    ...
                                    : p
                                    ? y._getServerData(d)
                                    : y.getInitialProps(l, { pathname: r, query: n, asPath: a })
                                })
                              )
                            case 22:
                              return (
                            ...
                            case 28:
                              return (
                                (t.prev = 28),
                                (t.t1 = t.catch(1)),
                                t.abrupt('return', this.handleRouteInfoError(t.t1, r, n, a))
                              )
                            case 31:
                            case 'end':
                              return t.stop()
              ...
              value: function (t, e) {
                ...
                return (
                  '/404' === o ||
                    ...
                    e.includes(o) ||
                    e.some(function (e) {
                      if ((0, d.isDynamicRoute)(e) && (0, g.getRouteRegex)(e).re.test(o))
                                    ...
                                    return (
                                      ...
                                      l._getStaticData(
                                        l.pageLoader.getDataHref(
                                          ...
                                          r,
                                          !0,
                                          'undefined' !== typeof n.locale ? n.locale : l.locale,
                                        ),
                                      )
                                    )
                                  }),
            ...
            },
            {
              ...
              value: function (e) {
                this.clc &&
                  (t.events.emit('routeChangeError', w(), e), this.clc(), (this.clc = null))
              },
            },
            {
              key: 'notify',
      ...
      var n = (function (t) {
        ...
        function s(t, e, r, o) {
          var a = e && e.prototype instanceof h ? e : h,
            ...
            u = new k(o || [])
          return n(i, '_invoke', { value: _(t, r, u) }), i
        }
        function l(t, e, r) {
          try {
        ...
        function x(t, e) {
          ...
          if (undefined === n)
            return (
              ...
              ('throw' === r &&
                t.iterator.return &&
                ((e.method = 'return'), (e.arg = undefined), x(t, e), 'throw' === e.method)) ||
                ('return' !== r &&
                  ((e.method = 'throw'),
          ...
          return a
            ? a.done
              ? ((e[t.resultName] = a.value),
                (e.next = t.nextLoc),
                'return' !== e.method && ((e.method = 'next'), (e.arg = undefined)),
                (e.delegate = null),
                f)
              : a
            : ((e.method = 'throw'),
          ...
          (k.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), P(r), f
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
